...
//           <tr>
//             <th className="py-5 px-6 text-left text-sm font-medium text-neutral-600 w-16">
//               Image
//             </th>
...
//               <td className="py-6 px-6 text-neutral-600 text-sm line-clamp-2 max-w-md">
//                 {product.description}
//               </td>
...
//               <td className="py-6 px-6">
//                 <span
//                   className={`font-medium ${product.stock < 100 ? "text-red-700" : "text-emerald-700"}`}
//                 >
//                   {product.stock}
//                 </span>
//               </td>
...
//                         stats.value ===
//                         dashboard?.insights?.topSellingProduct?.name
//                           ? "text-3xl"
//                           : "text-xl"
//                       }`}
//                     >
...
//                   alt="preview"
//                   className="max-h-48 rounded-lg border border-neutral-200/60"
//                 />
//               </div>
//             )}
